...
const Header = () => {
  ...
  return (
    <header className='w-full h-[105px] items-center'>
      <section className='flex max-w-[1160px] mx-auto p-[15px] items-center'>
        <Link to='/'><h1 className='text-3xl font-mono font-bold'>My-Community</h1></Link>
        <input type="search" placeholder="Search" className='border-2 border-purple-800 rounded ml-[220px] w-[250px] h-[30px] text-center'/>
      </section>
